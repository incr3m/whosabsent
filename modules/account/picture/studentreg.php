...
if(isset($_POST['idno'])){
  ...
  if ($result = $myCon->query("SELECT b.idno,concat(lastname,', ',firstname,middlename) as name,b.status,b.dateenrolled FROM account a, EnrolledStudent b where a.idno = b.accountidno ")) {
