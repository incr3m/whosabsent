...
<div class="list-primary-controls">
	...
	<a href="?module=<?php echo $_GET['module']; ?>"><i class="fa fa-chevron-left fa-2x"></i></a>
	<?php if(isModeIn([MODE_CREATE,MODE_UPDATE])==='false'){?>
	<a href="?module=<?php echo $_GET['module']; ?>&id=<?php echo $_GET['id']; ?>&mode=<?php echo MODE_UPDATE; ?>">
		<i class="fa fa-pencil fa-2x"></i></a>
	<a href="?module=<?php echo $_GET['module']; ?>&id=<?php echo $_GET['id']; ?>&mode=<?php echo MODE_DELETE; ?>">
